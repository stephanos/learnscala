 ...
 * Build: http://modernizr.com/download/#-fontface-opacity-rgba-cssgradients-localstorage-svg-cssclasses-teststyles-prefixes
 */
;
...
;
define("lib/init/modernizr", (function (global) {
    return function () {
...
define("lib/util/underscore", (function (global) {
    return function () {
        return global._;
    }
}(this)));
...
define("lib/util/underscore.str", (function (global) {
    return function () {
        return global._.str;
    }
}(this)));
...
define("lib/dom/bootstrap",[], function(){});
...
define('app/util/timer',["jquery", "lib/util/underscore", "lib/util/moment", "app/util/time", "lib/chart/piechart"], function($, _, moment, Time) {
  var Timer;
...
define('app/util/overlay',["jquery", "lib/util/underscore"], function($, _, d3) {
  var Overlay;
...
define('app/util/progress',["jquery", "lib/util/underscore"], function($, _) {
  var Progress, p;
  Progress = (function() {
...
define('app/util/countdown',["jquery", "lib/util/underscore", "lib/util/moment", "app/util/time"], function($, _, moment, Time) {
  var Countdown;
