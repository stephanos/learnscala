...
define("lib/chart/d3", (function (global) {
    return function () {
        return global.d3;
    }
}(this)));
...
define('app/slide/init',["jquery", "lib/util/underscore", "lib/reveal", "app/editor/init", "app/util/timer", "app/util/countdown", "app/util/overlay", "app/util/chart"], function($, _, Reveal, Editor, Timer, Countdown, Overlay) {
  var Slide;
