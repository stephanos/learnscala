...
object Query { //extends Rogue
    ...
    (f: Field[F, M]): NumericEnumerationQueryField[M, F] =
        new NumericEnumerationQueryField(f)
    ...
    type Query[T <: MongoRecord[T]] =
        ...
        subqueries.toList match {
          ...
          case q :: qs => {
            ...
            BaseQuery[M, M, Unordered, Unselected, Unlimited, Unskipped, HasOrClause](
              ...
              AndCondition(Nil, Some(orCondition)), None, None, None, empty = false)
          }
        }
      }
      ...
      implicit def metaRecordToQueryBuilder[M <: MongoRecord[M]]
        ...
        BaseQuery[M, M, Unordered, Unselected, Unlimited, Unskipped, HasNoOrClause](
          rec, None, None, None, None, None, AndCondition(Nil, None), None, None, None, empty = false)
